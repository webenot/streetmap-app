...
import './App.sass';
import { Icon, Map, Marker as LeafletMarker } from 'leaflet';
...
function DraggableMarker({ coords, setCoords }: IDraggableMarkerProps) {
